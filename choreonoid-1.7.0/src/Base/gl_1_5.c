...
static int Load_Version_1_5(void)
{
	...
	if (!GL15__ptrc_glGetTexLevelParameterfv)
		numFailed++;
	...
	if (!GL15__ptrc_glCopyTexImage1D)
		numFailed++;
	...
	if (!GL15__ptrc_glCopyTexImage2D)
		numFailed++;
	...
	if (!GL15__ptrc_glCopyTexSubImage1D)
		numFailed++;
	...
	if (!GL15__ptrc_glCopyTexSubImage3D)
		numFailed++;
	...
	if (!GL15__ptrc_glDrawRangeElements)
		numFailed++;
	...
	if (!GL15__ptrc_glCompressedTexImage1D)
		numFailed++;
	...
	if (!GL15__ptrc_glCompressedTexImage2D)
		numFailed++;
	...
	if (!GL15__ptrc_glCompressedTexImage3D)
		numFailed++;
	...
	if (!GL15__ptrc_glCompressedTexSubImage1D)
		numFailed++;
	...
	if (!GL15__ptrc_glCompressedTexSubImage2D)
		numFailed++;
	...
	if (!GL15__ptrc_glMultiDrawArrays)
		numFailed++;
